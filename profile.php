    ...
    <div class="row justify-content-center">
        <div class="card col-md-6 mb-4 p-2 mr-2" style="width: 18rem;">
            ...
            <?php if ($documents['student_resume']): ?>
                <iframe src="student_documents/<?php echo $documents['student_resume']; ?>" title="student_resume"></iframe>
            <?php else: ?>
        ...
        <div class="card col-md-6 mb-4 p-2 mr-2" style="width: 18rem;">
            ...
            <?php if ($documents['student_cover_letter']): ?>
                <iframe src="student_documents/<?php echo $documents['student_cover_letter']; ?>" title="student_cover_letter"></iframe>
            <?php else: ?>
        ...
        <div class="card col-md-6 mb-4 p-2 mr-2" style="width: 18rem;">
            ...
            <?php if ($documents['student_projects']): ?>
                <iframe src="student_documents/<?php echo $documents['student_projects']; ?>" title="student_projects"></iframe>
            <?php else: ?>
